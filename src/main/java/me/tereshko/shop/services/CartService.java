...
public class CartService {
    ...
    public Cart1 save(Cart1 cart) {
        return cartRepository.save(cart);
    }

    public Optional<Cart1> findById(UUID id) {
    ...
    public void addToCart(UUID cartId, Long productId) {
        ...
        Cart1 cart = findById(cartId).orElseThrow(() -> new ResourceNotFoundException("Unable to find cart with id: " + cartId));;
